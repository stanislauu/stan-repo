...
def shift_letter(letter, shift):
    ...
    *Note: the single underscore `_` is used to acknowledge the presence
    ...
    if letter == " ":
        ...
        # Convert the letter to its corresponding ASCII value
        letter_value = ord(letter) - ord("A")

        # Shift the letter value by the given number
        shifted_value = (letter_value + shift) % 26

        # Convert the shifted value back to the corresponding letter
...
def shift_by_letter(letter, letter_shift):
    ...
    if letter == " ":
        ...
        shift_value = (ord(letter_shift) - ord("A")) % 26
        letter_value = ord(letter) - ord("A")
